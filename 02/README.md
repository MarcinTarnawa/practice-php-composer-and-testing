...
# `#02` PHP: Composer and Testing

Zaimplementuj wczytywanie danych przy pomocy `autoload.php` dostępnego w katalogu `vendor` i wykorzystaj go do uruchomienia kilku wcześniej stworzonych klas.
