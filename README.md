...
# PHP: Composer and Testing (47-50)

Prezentowane zadania są przygotowane na podstawie rozdziału "[Meet Composer, Testing, Wrappint up (47-50)](https://laracasts.com/series/php-for-beginners-2023-edition/episodes/47)" dla kursu "[PHP for Beginners](https://laracasts.com/series/php-for-beginners-2023-edition)". Użyj [linku polecającego](https://laracasts.com/referral/bogolubow), aby się zarejestrować i docenić moją pracę.
